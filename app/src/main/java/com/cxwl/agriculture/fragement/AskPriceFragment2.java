...
import com.cxwl.agriculture.view.BaseFragment;
import com.cxwl.agriculture.view.RootLayout;
import com.cxwl.agriculture.volley.StringRequest;
 ...
 */
public class AskPriceFragment2 extends BaseFragment implements View.OnClickListener, View.OnLongClickListener{
    ...
    @Override
    protected void load(final Response.Listener<String> listener, final Response.ErrorListener errorListener) {
    ...
    protected View createSuccessView() {
        rootView = layoutInflater.inflate(R.layout.fragment_ask, null);
        initView();
        return rootView;
    }
