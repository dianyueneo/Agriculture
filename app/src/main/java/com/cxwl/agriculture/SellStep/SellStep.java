...
import com.xn121.scjg.nmt.scaleview.ScaleEditText;
import com.xn121.scjg.nmt.scaleview.ScaleTextView;
...
public class SellStep extends AbstractHandler implements Handler{
    ...
    private void setStatus(int status){
        ...
        for(Object obj: widgets){
            ...
            }else if(obj.getClass().equals(ScaleTextView.class) ||obj.getClass().equals(AppCompatTextView.class) || obj.getClass().equals(TextView.class)){
            ...
            }else if(obj.getClass().equals(ScaleEditText.class) ||obj.getClass().equals(AppCompatEditText.class) || obj.getClass().equals(EditText.class)){
