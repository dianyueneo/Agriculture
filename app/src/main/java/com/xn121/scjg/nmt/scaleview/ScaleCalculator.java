...
public class ScaleCalculator {
	...
	private static float mCurrentWidth = 720.0f;
	private static float mCurrentHeight = 1280.0f;
	...
	private final void getScreenSize(Context context) {
		...
		mCurrentHeight = displayMetrics.heightPixels;
	}
//	/**
//	 * 获取状态栏高度
//	 * @param context
...
//			e1.printStackTrace();
//		}
//		Log.e("mzj", "statusBarHeight:"+statusBarHeight);
...
//	}
	 ...
	 * 判断api等级
	 * 
	 * @return true：api等级 <= 15 false：api等级 > 15
	 */
	private boolean isIceCreamSandwichMR1OrOld() {
		int version = SystemUtil.getAndroidSDKVersion();
		if (version <= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1) {// api <= 15
			return true;
		} else {
			return false;
		}
